(function () {
  ...
  const getOrderProductBatchLimit = () => supportsOrderProductLazyLoad() ? ORDER_PRODUCT_BATCH_SIZE : Number.MAX_SAFE_INTEGER;
    ...
    "acelga.jpg",
    "achicoria.jpg",
    "aji_dulce_pizero_kg.jpg",
    "aji_en_polvo_kg.jpg",
    "aji_picante_kg.jpg",
    "ajo_cabeza.jpg",
    "ajo_ristra.jpg",
    "albahaca_hidroponica.jpg",
    "albahaca_seca_kg.jpg",
    "albahaca_unidad.jpg",
    "alcaucil.jpg",
    "almendras_kg.jpg",
    "anana.jpg",
    "apio.jpg",
    "arandanos_bandeja.jpg",
    "arandanos_congelados.jpg",
    "arveja_kg.jpg",
    "banana_cajon.jpg",
    "bananas_docena.jpg",
    "batata_bolsa.jpg",
    ...
    "calabaza_kg.jpg",
    "canela_en_polvo_kg.jpg",
    "canela_rama_kg.jpg",
    "cebolla_bolsa.jpg",
    "cebolla_kg.jpg",
    "cebolla_morada_bolsa.jpg",
    "cebolla_morada_kg.jpg",
    "cereza_kg.jpg",
    "champinon.jpg",
    "chaucha_kg.jpg",
    "choclo_amarillo_bolsa.jpg",
    "choclo_amarillo_docena.jpg",
    "choclo_blanco_bolsa.jpg",
    "choclo_blanco_docena.jpg",
    "cilantro.jpg",
    "ciruela_cajon.jpg",
    "ciruela_kg.jpg",
    "coliflor.jpg",
    ...
    "frutilla_cajon.jpg",
    "frutilla_kg.jpg",
    "frutos_rojos_congelados.jpg",
    "garbanzo_kg.jpg",
    "habas_kg.jpg",
    "higo_cajon.jpg",
    "higos_por_kg.jpg",
    "hongos_de_pino_kg.jpg",
    "huevos_caja.jpg",
    "huevos_maple.jpg",
    "kiwi unidad.png",
    "kiwi_kg.jpg",
    ...
    "nabos_atado.jpg",
    "naranja_docena.jpg",
    "naranja_grande_jaula.jpg",
    "naranja_jaula.jpg",
    "nueces_mariposa_kg.jpg",
    "nueces_partida_kg.jpg",
    "oregano_kg.jpg",
    "palta_criolla_kg.jpg",
    "palta_madura_kg.jpg",
    "papa_bolsa.jpg",
    "papa_kg.jpg",
    "papaya_unidad.jpg",
    ...
    "pomelo_jaula.jpg",
    "poroto_negro_kg.jpg",
    "poroto_pallares_kg.jpg",
    "provenzal_kg.jpg",
    "puerro.jpg",
    "quesillo.jpg",
    "queso_de_cabra_horma.jpg",
    "quinoa_kg.jpg",
    "radicheta.jpg",
    "remolacha.jpg",
    "repollo_blanco.jpg",
    "repollo_morado.jpg",
    "repollos_de_brucelas_kg.jpg",
    "rucula_hidroponica.jpg",
    "rucula_unidad.jpg",
    "sandia.jpg",
    "tanjarina_jaula.jpg",
    "tomate_cajon.jpg",
    ...
    "tomate_redondo_cajon.jpg",
    "tomate_redondo_kg.jpg",
    "tomillo_polvo_kg.jpg",
    "uva_huevo.jpg",
    "uva_kg.jpg",
    "uva_negra.jpg",
    "uva_rosa_kg.jpg",
      ...
      <div class="grid two" style="margin-top:14px">
        ...
        ${(currentUser.role === "manager" || currentUser.role === "admin") ? `<div class="panel">
          ...
          <div class="form-grid" style="margin-top:8px;max-height:320px;overflow:auto;padding-right:6px">
            ...
            <div class="field span-4"><label><input type="checkbox" id="whatsapp-enabled" ${!state.appSettings || state.appSettings.whatsappEnabled !== false ? "checked" : ""} style="width:auto;min-height:auto" /> Enviar WhatsApp automáticos (mora, avisos de cambio de pedido, suba de precio, feriados). Destildá para desactivar todos los WhatsApp automáticos.</label></div>
            <div class="field span-4"><label><input type="checkbox" id="billing-enabled" ${!state.appSettings || state.appSettings.billingEnabled !== false ? "checked" : ""} style="width:auto;min-height:auto" /> Facturación automática activada. Destildá para pausar la emisión automática de facturas (la facturación manual sigue disponible).</label></div>
  ...
  function bindSettings() {
    ...
    if (whatsappEnabled) whatsappEnabled.addEventListener("change", () => { state.appSettings.whatsappEnabled = whatsappEnabled.checked; saveState(); });
    const billingEnabled = document.getElementById("billing-enabled");
    if (billingEnabled) billingEnabled.addEventListener("change", () => { state.appSettings.billingEnabled = billingEnabled.checked; saveState(); });
  ...
  function adjustParsedQuantityAndUnitForProduct(quantity, unitType, product, nameTokens) {
  ...
  function matchProductForParsedLine(name, unitType, clientId) {
    ...
    const exactCandidates = activeProducts().map((product) => {
      ...
      const productSearchText = singularizeParsedProductText(productText);
      ...
      return {
        product,
        score: 105 + (preferred ? 10 : 0) + (unitMatches ? 8 : 0) - Math.max(0, productSearchText.length - searchableWithUnit.length) / 100,
        exact: true,
        preferred,
        unitMatches,
        nameLength: productSearchText.length
      };
  ...
  function isWholesaleParsedUnit(unitType) {
    const clean = normalizeText(unitType);
    return clean === "jaula" || clean === "cajon" || clean === "bolsa";
  }

  function isLikelyLooseUnitCountName(nameTokens) {
  ...
  function singularizeParsedWord(value) {
    const clean = normalizeText(value);
    if (clean.length > 5 && clean.endsWith("ces")) return clean.slice(0, -3) + "z";
